...
export const sprint3Idea2: Flow = {
  ...
  rationale: [
    ...
    "The columns are the work, so they take four fifths of the window and the results take the rest. That pane is a live count you glance at while you cut, not a table you sit and read, and the whole record opens on demand.",
    ...
    "Three columns up front — name, stage, company — and every other field a drawer away rather than a column away. At a fifth of the window a six-column grid is six ellipses, so the record is moved rather than cut.",
    ...
    "At the sprint's 1440px review viewport the panel holds three columns with nothing truncated; the fourth appears above 1680px. The column count yields to the 16px baseline, which is this direction's own premise — cap the depth on screen at three and let the breadcrumb carry the rest.",
  ],
