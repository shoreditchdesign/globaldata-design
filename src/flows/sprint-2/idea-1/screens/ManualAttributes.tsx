...
import {
  ...
  CascadeRow,
  ManualPane,
} from "@/flows/sprint-2/idea-1/components/ManualPane"
import { Results } from "@/flows/sprint-2/idea-1/screens/Results"
import { drugAttributes } from "@/flows/sprint-2/idea-1/data"
    ...
    <>
      ...
      <FilterModal tab="manual">
        <ManualPane
          ...
          dimOthers
          popover={
            <CascadePanel title="Drugs" className="top-[3.5rem] left-[6.5rem]">
