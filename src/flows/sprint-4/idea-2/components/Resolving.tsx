...
import { inertHandlers } from "@/flows/sprint-4/idea-2/components/ValueMenu"
import type { Resolution } from "@/flows/sprint-4/idea-2/resolve"
 ...
 * simply appears.
 *
 * Idea 3's resolve, carried across whole. The timings live in
 * `src/components/prototype/motion.ts`.
 */
    ...
    <div>
      <div className="grid">
        ...
        <p
          aria-live="polite"
          className={cn(
            "ease-settle col-start-1 row-start-1 text-[22px] leading-[2.23] tracking-[-0.01em] transition-opacity duration-200 motion-reduce:transition-none",
