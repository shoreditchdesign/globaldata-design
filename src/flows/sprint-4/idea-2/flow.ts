...
export const sprint4Idea2: Flow = {
  ...
  screens: [
    ...
    {
      slug: "pulled-apart",
      title: "A value pulled out",
      note: "`small molecules in europe or north america`, with North America dragged out of the geography group. It joins with OR and the query reads left to right, so the set is now small molecules in Europe, or anything in North America: 598 drugs where the group gave 400. Undo puts it back.",
      viewport: "desktop",
      component: Screener,
    },
    {
