...
export const sprint4Idea2: Flow = {
  ...
  screens: [
    ...
    {
      slug: "explorer-open",
      title: "Explorer, collapsed",
      note: "Explorer split in from the head of the results: the Drugs taxonomy, an attribute per branch, every branch shut. Nothing is ticked, so the grid is still empty.",
      viewport: "desktop",
      component: Screener,
    },
    {
    ...
    {
      slug: "filter-ticked",
      title: "Ticked, not resolved",
      note: "Two stages ticked in the dropdown and written into the line above as they were ticked. Nothing has reached the table yet.",
      viewport: "desktop",
      component: Screener,
    },
    {
      slug: "explorer-expanded",
      title: "Branches open",
      note: "Two attributes opened in the tree, their values counted against the query as it stands. Nothing ticked, so nothing has moved.",
      viewport: "desktop",
      component: Screener,
    },
    {
      ...
      note: "Three values ticked across three branches, with the rail counting them. The grid still holds the query from before until Apply filters is used.",
      viewport: "desktop",
      component: Screener,
    },
    {
